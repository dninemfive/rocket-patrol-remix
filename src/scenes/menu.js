class Menu extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.text(game.config.width / 2, borderUISize + borderPadding, "Press M to toggle mouse control.", textConfig).setOrigin(0.5);
        this.controlText = this.add.text(game.config.width / 2, game.config.height / 2, "", textConfig).setOrigin(0.5);
        if(useMouse){
